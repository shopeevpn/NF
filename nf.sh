...
export LC_ALL="en_US";
clear;
echo -e "${Font_Red}The script comes from the Internet, and the ownership belongs to the author.${Font_Suffix}";
echo -e "${Font_Red}The test results of this tool are for reference only, please refer to actual use${Font_Suffix}";
echo -e "${Font_Red}Purchase a regular Netflix account  https://jcnf.xyz/nf${Font_Suffix}";
...
echo " ** Testing the IPv4 unlocking situation		";
...
echo " ** IPv6 unlocking is being tested";
